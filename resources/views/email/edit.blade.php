        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('/update',array($user->id)) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('address_to') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address_to" type="text" class="form-control" name="address_to" value="{{ $user->address_to }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('college_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="college_name" type="text" class="form-control" name="college_name" value="{{  $user->college_name }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('college_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="college_address" type="text" class="form-control" name="college_address" value="{{  $user->college_address }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('college_email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="college_email" type="text" class="form-control" name="college_email" value="{{  $user->college_email }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="subject" type="text" class="form-control" name="subject" value="{{  $user->subject }}" required autofocus>
